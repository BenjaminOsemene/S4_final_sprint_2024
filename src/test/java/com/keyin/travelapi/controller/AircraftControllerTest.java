...
//                .andExpect(jsonPath("$[0].numberOfPassengers").value(366));
//
...
//                .andExpect(jsonPath("$.numberOfPassengers").value(366));
//
...
//        when(aircraftService.getAircraftById(1L)).thenReturn(Optional.empty());
//
//        mockMvc.perform(get("/api/aircraft/1"))
