...
//
//    @Test
//    void getPassengerById_shouldReturnNotFound_whenPassengerDoesNotExist() throws Exception {
...
//
//    @Test
//    void deletePassenger_shouldReturn404WhenDeletingNonExistentPassenger() throws Exception {
//        when(passengerService.getPassengerById(1L)).thenReturn(Optional.empty());
//
//        mockMvc.perform(delete("/api/passengers/1"))
//                .andExpect(status().isNotFound());
//
//        verify(passengerService).getPassengerById(1L);
//        verify(passengerService, never()).deletePassenger(1L);
//    }
//
//    @Test
